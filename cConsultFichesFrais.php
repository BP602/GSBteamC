...
<div id="contenu">
	<?php
	//si comptable tous les utilisateurs
	if ($typeUser == 1){ ?>
	...
	if ( $etape == "validerConsult" ) {
		if ( nbErreurs($tabErreurs) > 0 ) {
			...
			?>
			<h3>Fiche de frais du mois de <?php echo obtenirLibelleMois(intval(substr($moisSaisi,4,2))) . " " . substr($moisSaisi,0,4); ?> de <?php $detailsVisSaisi = obtenirDetailVisiteur($idConnexion, $visSaisi); echo $detailsVisSaisi["nom"]." ".$detailsVisSaisi["prenom"]; ?>: 
