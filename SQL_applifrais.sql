...
--
-- Client: localhost
-- Généré le: Lun 10 Novembre 2014 à 08:45
...
INSERT INTO `visiteur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `types`) VALUES
...
GRANT ALL PRIVILEGES ON gsb_frais.* TO "userGsb"@"localhost" IDENTIFIED BY 'secret'; // Modifier localhost en % pour se connecter depuis le PC utilisateur.
